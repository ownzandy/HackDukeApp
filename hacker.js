  ...
  getInitialState: function() {
    ...
    dataBlob = {
      ...
      '12:00-3:00 PM':[ {'time':'12:30-1:30','name':'Opening Ceremony', 'place':'Bryan Center, Reynolds Auditorium'},
                       ...
                       {'time':'2:30','name':'Web Bootcamp Starts', 'place':'Teer Building 115'}],
      '3:00-6:00 PM':[{'time':'4:00','name':'DiVE Tours Begin', 'place':'FCIEMAS Floor 1'}],
      '6:00-9:00 PM':[{'time':'6:00-7:30','name':'Dinner and Talks', 'place':'FCIEMAS Floor 1 Schiciano Entrance'}, {'time':'6:30','name':'DiVE Tours End', 'place':'FCIEMAS Floor 1'}, {'time':'8:00-9:00','name':'Ladies Dessert Meetup', 'place':'FCIEMAS Floor 1 Schiciano Entrance'}, {'time':'8:00','name':'Web Bootcamp Ends', 'place':'Teer Building 115'}],
      ...
      ' 3:00-6:00 PM':[{'time':'4:30-5:30','name':'Closing Ceremony', 'place':'Bryan Center, Reynolds Auditorium'}, {'time':'5:30 PM','name':'Departure', 'place':'FCIEMAS'}],
    };
